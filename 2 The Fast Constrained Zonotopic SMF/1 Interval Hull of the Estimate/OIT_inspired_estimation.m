function cZ_posterior = OIT_inspired_estimation(A, B, C, cZ_prior_, cZ_w, cZ_v, y_sequence, k, delta, column_scaling_flag, B_u, u_sequence, prior_refinement_flag)
...
%   (c) Yirui Cong, created: 31-Aug-2021, last modified: 05-Oct-2022
